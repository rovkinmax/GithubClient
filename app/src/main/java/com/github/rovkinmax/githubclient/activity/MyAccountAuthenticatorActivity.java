 ...
 * to handle the request then it can have the activity extend MyAccountAuthenticatorActivity.
 ...
 */
public abstract class MyAccountAuthenticatorActivity extends AppCompatActivity {
